...
・訳追加修正: Eclipse, STS, CheckStyle, WTP, PDE

2020.09.20

・[Eclipse][github#68] ファセット関係の誤訳
・Android Studio 4.1 インストーラー対応
・訳追加修正: Eclipse, STS / IntelliJ, Android Studio

2020.07.02

・[Eclipse][github#63] 関数一覧に「======」が表示される問題の対応
・訳追加修正: Eclipse, STS / PhpStorm

2020.06.28

・Eclipse 2020-06 スプラッシュ画像追加
・訳追加修正: Eclipse, STS / IntelliJ, Android Studio

2020.06.14

・[IDEA][github#60] vmoptions 位置変更対応で Android Studio 4.2 以降としていたが、4.1 以降に修正
...
・[IDEA] Material UI Theme の設定が開けない問題を修正
・[IDEA] Android Studio のデザイナービューで属性が翻訳されてしまう問題を修正
・[IDEA] 訳追加修正: IDEA、Material UI Theme
・[Eclipse] ワークスペース作成時に自動設定される日本語 Javadoc URL の Java 11 対応
・[Eclipse] 訳追加修正: Eclipse

2018.11.24

・[IDEA] Windows 版インストーラで vmoptions は Shift_JIS で保存するように修正
・[IDEA] 訳追加修正: AndroidStudio, Clion, IDEA, Goland, PhpStorm, PyCharm, ReSharper, Rider, RubyMine, WebStorm
・[Eclipse] 訳追加修正: Eclipse, PDT, Subversive
